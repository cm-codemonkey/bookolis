<?php defined('_EXEC') or die; ?>
        ...
        <footer class="main-footer">
            <section class="copyright">
                <div class="container">
                    Copyright © 2020 <b>{$vkye_webpage}</b> <i class="mdi mdi-heart text-danger"></i> {$lang.development_by} <a href="https://codemonkey.com.mx" target="_blank">Code Monkey</a>
                </div>
            </section>
        </footer>
        ...
        <script src="//code.tidio.co/5xkwwfmqmr6vqwuvv9kbjz0zsppisycd.js" async></script>
        {$dependencies.js}
        {$dependencies.other}
    </body>
</html>
