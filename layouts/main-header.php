    ...
    <div class="topbar-main">
        <div class="container">
            <div class="row">
                ...
                <div class="col-2 col-lg-9 d-flex flex-column justify-content-center align-items-end">
...
<header class="mobile-header">
    <ul class="list-inline m-0 m-b-20">
        <li class="list-inline-item m-0">
            <a href="javascript:void(0);" data-button-modal="signup" class="btn">{$lang.signup_now}</a>
        </li>
    </ul>
    ...
    <ul class="list-inline m-0 m-t-20">
        <li class="list-inline-item m-0">
            <a href="https://bookolis.app.pricenavigator.net/login/b2b#!/hotel" data-button-modal="signup" class="btn" target="_blank">{$lang.login}</a>
        </li>
    </ul>
    <ul class="list-inline m-0 m-t-20">
        <li class="list-inline-item m-0">
